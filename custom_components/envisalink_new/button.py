...
async def async_setup_entry(
    ...
    # validated against the Vista-20P and Vista-21iP, which program
    # identically (see zone_discovery.py / docs/zone_discovery.md). Gate on the configured panel model too, not just
