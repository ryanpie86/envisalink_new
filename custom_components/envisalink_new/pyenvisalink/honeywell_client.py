...
class HoneywellClient(EnvisalinkClient):
    ...
    async def discover_zone_info(
        ...
        zone's currently-programmed type and, if include_names is True,
        alpha descriptor -- the same data an installer would read off a
        physical alpha keypad. See pyenvisalink/honeywell_zone_discovery.py
